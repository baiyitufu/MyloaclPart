...
#import "MyPlayerActionView.h"
#import "PlayBarTopView.h"
...
@property (readwrite, strong) MyPlayerListViewZH *playListView;
@property (readwrite, strong) MyPlayerActionView *actionViewZh;
@property (readwrite, strong) PlayBarTopView *barTopView;
